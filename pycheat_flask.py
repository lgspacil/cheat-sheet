...
# under the schemas list you should be able to see all of your different databases
...
# display that session data in your html file using jinja, and make sure that works before adding more complicated session data
